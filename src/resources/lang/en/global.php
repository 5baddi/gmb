...
return [
    ...
    'generate_gmb_post_summary_prompt' => 'Write a professional Google My Business summary based on the following topic. The summary should be less than or equal 1500 characters and written in the same language as the topic provided. Ensure the summary is engaging, informative, and highlights key aspects relevant to the topic.',
