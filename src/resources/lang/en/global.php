...
return [
    ...
    'generate_gmb_post_summary_prompt' => 'Write a professional Google My Business post summary that is more than 1500 characters based on the following topic. The summary should be written in the same language as the topic provided. Ensure the summary is engaging, informative, and highlights key aspects relevant to the topic.',
    'missing_gmb_post_summary' => 'Please enter your topic',
    'review_reply_prompt' => 'Write a professional reply that is more than 1500 characters to the following customer review. The reply should be written in the same language as the review. Ensure the response is respectful, addresses any concerns raised, and highlights the positive aspects of the customer\'s experience.',
